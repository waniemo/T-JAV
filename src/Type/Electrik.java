        ...
        switch(attack){
            case "Eclair":
                if(attacks.get("Eclair") == 0){
                    System.out.println("Vous n'avez pas assez de PP pour utiliser Eclair !");
                    break;
                } else{
            ...
            case "Cage-Eclair":
                if(attacks.get("Cage-Eclair") == 0){
                    System.out.println("Vous n'avez pas assez de PP pour utiliser Cage-Eclair !");
                    break;
                } else{
            ...
            case "Fatal-Foudre":
                if(attacks.get("Fatal-Foudre") == 0){
                    System.out.println("Vous n'avez pas assez de PP pour utiliser Fatal-Foudre !");
                    break;
                } else{
